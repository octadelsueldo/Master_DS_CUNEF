...
#-----------------------------------------------------------------
#Para la base de datos Swiss realizar un an ́alisis exploratorio multivariante completo, con los siguientes elementos:
#(i) Realizar un an ́alisis exploratorio univariante, incluyendo histogramas y estimadores nu ́cleo de las variables marginales
#(ii) Obtener medidas exploratorias multivariantes
#(iii) Visualizaci ́on de los datos, mediante diversos m ́etodos
...
#-----------------------------------------------------------------
# Estandarizaci?n multivatiante de Swiss
#-----------------------------------------------------------------
